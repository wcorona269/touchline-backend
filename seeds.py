...
user_seeds = [
    ...
    ['lewanGOALski', "Ripping the nets apart with powerful shots. Goalkeeper's nightmare!", 'https://touchlinedevstorage.blob.core.windows.net/touchline-dev-pics/lewa.jpeg'],
    ['YungKylian',
    ...
    ['GuardiolaGene', "Maestro of dribbling skills. Dancing through defenders like they're not there.", 'https://touchlinedevstorage.blob.core.windows.net/touchline-dev-pics/pep.jpg'],
    ['UCL_warrior',
